...
contract Ownable {
    ...
    event OnwershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    modifier onlyOwner(){
        require(isOwner(),"Owner of this contract is required");
        _;
    }
...
contract Pausable is Ownable{
    ...
    modifier whenNotPaused(){
        require(!paused, "Contract should be unpaused");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        return _ownerTokenCount[owner].current();
    }
